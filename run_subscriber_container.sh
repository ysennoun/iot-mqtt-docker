...
docker run --net iot-mqtt-network --hostname subscriber --add-host s1-emqtt-io:192.168.1.10 --add-host s2-emqtt-io:192.168.1.11 --ip 192.168.1.21 -it iot-mqtt-docker-image:0.0.1 bash
